...
dbc.Row(
     ...
     dbc.Row([
        ...
        dbc.Tooltip(
            ...
            dbc.CardImg(src="https://github.com/fdealbam/violenciadegenero/blob/main/application/static/Mapa%20Total2015.png?raw=true",
                                           ),
        ...
        dbc.Tooltip(
            ...
            dbc.CardImg(src="https://github.com/fdealbam/violenciadegenero/blob/main/application/static/Mapa%20GRAND%20TOTAL.png?raw=true",
                                           ),
               ]), style={"background-color":"lightgray",
                        # "box-shadow": "10px 20px 30px black",
                         'margin-left': '10px',
...
############################################################## Seccion numeralia    
 html.Hr(style={"border-left": "1px solid gray",
  ...
  "marin-top": "1100px",
    ...
    dbc.Row([
        dbc.Col(html.P(
            "En el acumulado de cinco años de delitos de violencia de género,  la inasistencia familiar"
            " fue el único delito que redujo su incidencia (%)", 
                       style={'textAlign': 'justify',
                              "left": "50%",
                             "font-size": "18px",
                             "font-family": "Arial",
