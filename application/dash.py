...
#Grafica
#grap = pd.read_csv("htps://raw.githubusercontent.com/fdealbam/violenciadegenero/main/pagrafica.csv")
...
#         (delitos["Tipo de delito"]== "Otros delitos que atentan contra la libertad personal")|# OEntrada violencia de genero
...
acumulado_meses = femi15_21[[
    ...
    'Enero21','Febrero21','Marzo21','Abril21','Mayo21']].stb.subtotal().tail(1).T.to_csv("0000procesoheadr.csv")
...
femi15_21["var_sep17_18_%"] = (femi15_21["var_sep17_18"]*100)/femi15_21.Septiembre18
femi15_21["var_oct17_18_%"] = (femi15_21["var_oct17_18"]*100)/femi15_21.Octubre18
femi15_21["var_nov17_18_%"] = (femi15_fa = y15.merge(y16, on="Entidad",  how="inner")
fb = fa.merge(y17, on="Entidad",  how="inner")
fc = fb.merge(y18, on="Entidad",  how="inner")
fd = fc.merge(y19, on="Entidad",  how="inner")
fe = fd.merge(y20, on="Entidad",  how="inner")
...
femi15_21 = ff[[
 ...
 'Enero20','Febrero20','Marzo20','Abril20','Mayo20','Junio20','Julio20',
 'Agosto20','Septembre20','Octubre20','Noviembre20','Diciembre20',
...
femi15_21['Total2016']= femi15_21[[ 'Enero16', 'Febrero16', 'Marzo16', 'Abril16', 'Mayo16',
                               'Junio16', 'Julio16', 'Agosto16', 'Septiembre16', 'Octubre16',
                               'Noviembre16', 'Diciembre16',]].sum(axis=1)
femi15_21['Total2017']= femi15_21[[ 'Enero17', 'Febrero17', 'Marzo17', 'Abril17', 'Mayo17',# OEntrada violencia de genero
